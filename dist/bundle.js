...
(function () {
	...
	*/
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	{(function(){var React=react.exports;var _assign=objectAssign;var Scheduler=scheduler.exports;var checkPropTypes=checkPropTypes_1;var tracing$1=tracing.exports;var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// Prevent newer renderers from RTE when used with older react package versions.
	...
	***************************************************************************** */
	...
	var MaskedInput = react.exports.forwardRef(function (props, ref) {
	    ...
	    if (children) {
	        return React.cloneElement(children, __assign(__assign(__assign({}, (value !== null ? { value: value } : {})), { disabled: disabled, readOnly: readOnly, onChange: onChangeHandler, onBlur: onBlur, ref: inputRef }), rest));
	    }
	...
	var App = function () {
	    ...
	    var _b = react.exports.useState(''), value2 = _b[0], setValue2 = _b[1];
	    ...
	    return (React.createElement(React.Fragment, null,
	        React.createElement("h1", null, "App Tests"),
	        ...
	        " ",
	        React.createElement("br", null),
	        React.createElement(MaskedInput, { value: value2, onChange: onChange2, mask: '99/99/9999' }),
